...
public class MainTest {
    ...
    @Test
    @DisplayName("Test \"parceCSV()\" static method, using 'Hamcrest' ...")
    public void parseCSVHamcrestTest(TestInfo parseCSVHamcrestTestInfo) {
        ...
        for (int i = 0; i < expected.size(); i++) {
            assertThat(expected.get(i), equalTo(actual.get(i)));
        }

        System.out.println(parseCSVHamcrestTestInfo.getDisplayName() + " complete!");
    }
